  ...
  return (
      <LayoutEmbeddedPage >
        ...
        <div id="contest-closed" className="us-site en ms-contest  ms-contest--laketahoe pb-0">
          ...
          <MicrositeFooter customPage="laketahoe"/>
        </div>
      </LayoutEmbeddedPage>
  )
}
...
export const query = graphql`
  ...
  prismicMicrosite (uid: {eq: "laketahoe"}) {
    _previewable
    data {
      body {
...
`
export default withPrismicPreview(LakeTahoeMicrositePage)