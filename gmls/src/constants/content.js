...
const home_intro =
  'At Glendalough Distillery we progressively-craft luxury spirits in the Wicklow Mountains. We hope these spirits evoke a sense of place through their depth of flavour as they are an expression of what we love about these mountains.'
...
const gins = {
  'rose-gin': {
    ...
    note_p1:
      'Bright lemon and blood orange, soft juniper notes, deep aromatic notes, perfumed with fresh rose.',
    note_p2_heading: 'The Taste',
    note_p2:
      'Distinct Rose Petal, turkish delight, bright berries, with a nectar sweetness.',
...
const whiskey_features = [
  {
    ...
    intro:
      'Donec pharetra imperdiet dolor, ut cursus enim dictum vitae. L orem ipsum dolor sit amet, consectetur adipiscing elit. Nam auctor vestibulum nibh nec ullamcorper. Aliquam orci ante, condimentum ac auctor vel, eleifend sit amet elit. Aliquam erat volutpat. Praesent sed urna non elit interdum porta.',
    p1heading: 'Folklore',
...
const features = [
  {
    ...
    summary:
      "“All the plants are sustainably picked by our full time forager, every day we distil. We take a lot of care that we don't adversely affect the areas we find them in.”",
    primary_ps: [
    ...
    secondary_title:
      'Lorem Ipsum sit dalor, eaque quae abill inventore quasi dicta',
    secondary_p1:
      ' Nullam eleifend lorem ipsum, sed ornare ante convallis vitae. Praesent in varius odio. Nam vel tempor diam. Ut condimentum efficitur sapien ac tincidunt. Ut tincidunt, augue sed rutrum fermentum, tellus massa lacinia urna, nec condimentum orci arcu non ante. Aliquam tempus dui vitae erat pretium pretium. Curabitur vel mollis leo.',
    secondary_p2:
      'Aenean rhoncus nibh eleifend, luctus nunc nec, malesuada eros. Ut eu ipsum semper lacus varius euismod a sit amet mauris. Donec sit amet iaculis velit, nec consequat ligula. Nunc feugiat erat ac magna faucibus cursus. Ut diam ex, rhoncus vitae lorem quis, interdum facilisis nibh. Cras eu dolor nisl. Mauris hendrerit maximus ante nec maximus.',
