const privacy = {
    ...
    sections: [
        {
            title: "Introduction",
            ps:["All references to 'our', 'us', 'we' or 'company' within this policy and within the opt-in notice are deemed to refer to Glendalough Irish Whiskey Limited. Your personal privacy is important to us, so we will always endeavor to protect it. This Privacy Policy will help you to understand what we may do with any of your personal information that we obtain from you. By giving your personal information to us, you signify your acceptance of our Privacy Policy and agree that we may collect, use and disclose your personal information as described in this Privacy Policy. If you do not agree with this policy, please do not provide your personal details to us. This Privacy Policy is incorporated into, and part of, the Terms and Conditions, which govern your use of this website in general. We will only use your information for the purposes set out below. We may need to update this Privacy Policy from time to time. We recommend that you regularly check this page to ensure that you have read the most recent version."]
        },
        {
            title: "Legal purchase age",
        ...
        },
        {
            ...
            ps:["Personal information is information about an identifiable individual, as defined by applicable law. It does not include aggregated information that does not allow you to be identified, nor does it include business contact information such as your name, title, business address and business phone number."]
        },
        {
            title: "Collecting personal information",
            ps: ["You can decide what personal information you provide to us. We will only collect personal information that you choose to provide. Where possible, we will enable you to select how we will use this information (for example, by choosing to opt-in or opt-out of receiving emails or digital advertising from us).", 
        ...
        {
            title: "Use of cookies on our websites",
            ps: ["We use “cookies” to help us gather and store information about visitors to our websites. A cookie is a small data file that our server sends to your browser when you visit the site. You can delete cookies at any time or you can set your browser to reject or disable cookies. You can obtain information about how to manage cookies at www.aboutcookies.org.",
            "We may use information from cookies for the following purposes:1. Traffic monitoring, e.g., the IP address from which you access the site, the type of browser and operating system used to access the site, the date and time of your access to the site, the pages you visit, and the Internet address of the website from which you accessed the site.2. To recognize repeat visitors for statistical / analytical purposes.3. Anonymous tracking of interaction with online advertising, e.g., to monitor the number of times that a banner ad is displayed and the number of times it is clicked.",
            "We may connect the information that we collect through cookies with other personally identifiable information that you provide to us. Such purposes are:1. To customize or personalise your experience of our website; for example, so that we can greet you on the website by name.2. For transactional purposes, such as credit card sales.3. To monitor your use of our website in order to make our communications to you as relevant as possible; for example, by sending you email communications relevant to the parts of the site that you visit most often or by letting you know about features of the site that you have not accessed previously.",
        ...
        },
        {
            ...
            ps: ["We may use and/or disclose personal information collected from you in one or more the following ways:",
        ...
        {
            title: "Disclosure Personal information",
            ps: ["In addition to disclosures identified in the purposes above, from time to time we may disclose personal information to:",
                "(a) our service providers and subcontractors, including our affiliates, retained to perform functions on our behalf or to provide services to us, such as warehousing and delivery; marketing and advertising; data processing; software development; website hosting and management; information technology and office services; legal, accounting, audit and other professional service providers; and further provided such service provider does not collect, use or disclose the personal information for any purpose other than to perform such functions or to provide services to us or as otherwise required by law;(b) a person or entity, including our affiliates, to whom disclosure is required in order to fulfill one or more of the purposes described above under “Purposes for Collecting Information”;(c) a person who, in our reasonable judgment, is providing or seeking the information as the authorised or appointed legal agent of the subject individual; or(d) any third party with your consent or where disclosure is required or permitted by law.",
